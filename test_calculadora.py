...
class TestCalculadora(unittest.TestCase):
    ...
    def test_sumar_dos_positivos_devuelve_suma(self):
    ...
    def test_sumar_dos_negativos_devuelve_suma_negativa(self):
        """Suma de dos enteros negativos: -2 + -7 = -9."""
        resultado = self.calc.sumar(-2, -7)
        self.assertEqual(resultado, -9)

    def test_sumar_numero_y_cero_devuelve_el_numero(self):
        """Elemento neutro de la suma: 4 + 0 = 4."""
        resultado = self.calc.sumar(4, 0)
        self.assertEqual(resultado, 4)

    def test_sumar_positivo_y_negativo_devuelve_resta(self):
        """Caso adicional: signos opuestos. 10 + (-4) = 6."""
        resultado = self.calc.sumar(10, -4)
        self.assertEqual(resultado, 6)

    def test_sumar_decimales_devuelve_suma_correcta(self):
    ...
    def test_dividir_dos_positivos_devuelve_cociente(self):
        """División exacta de positivos: 10 / 2 = 5."""
        resultado = self.calc.dividir(10, 2)
        self.assertEqual(resultado, 5)

    def test_dividir_dos_negativos_devuelve_positivo(self):
        """División de dos negativos: -10 / -2 = 5."""
        resultado = self.calc.dividir(-10, -2)
        self.assertEqual(resultado, 5)

    def test_dividir_cero_entre_numero_devuelve_cero(self):
    ...
    def test_dividir_por_cero_lanza_value_error(self):
        """
    ...
    def test_dividir_cero_entre_cero_lanza_value_error(self):
        """
